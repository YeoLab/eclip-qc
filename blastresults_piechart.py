...
sseq_count_series = df2['sseqid'].value_counts()
...
sseq_count_series2 = sseq_count_series.rename(replacements)
#sseq_count_series2 = sseq_count_series2.rename(index=dict(zip(sseq_name_list,sseqid)))
print(sseq_count_series2)
#csv_df = pd.DataFrame(sseq_count_series2)
#csv_df.to_csv('testoutput1.csv', index=False)
